...
import { ItemDetailShower} from "../view/ItemDetailShower"
...
//endregion
//region ItemDetailShower
const ItemDetails = new ItemDetailShower(document.getElementById("regioSelect"));
...
document.getElementById('getPicture').addEventListener('change', function(e){
    ItemDetails.HandleFileSelect(e);});
//endregion
//endregion
